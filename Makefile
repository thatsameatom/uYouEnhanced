...
export ADDITIONAL_CFLAGS = -I$(THEOS_PROJECT_DIR)/Tweaks/RemoteLog -I$(THEOS_PROJECT_DIR)/Tweaks -Wno-error=incompatible-pointer-types -Wno-error=incompatible-function-pointer-types -Wno-error=deprecated-declarations -Wno-error=implicit-function-declaration
